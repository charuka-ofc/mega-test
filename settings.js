...
SESSION_ID: process.env.SESSION_ID === undefined ? 'MIZUKI-MD=JMgDlRRI#ZkdyyWO5iTEY-XTZU0WGvZn-sR2ZwVgRSKO85cU8ez8' : process.env.SESSION_ID,
...
LANG: process.env.LANG ||  "SI",T: process.env.REACT || "💓💓",
